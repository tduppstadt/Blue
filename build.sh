...
echo "    - from Content/src/templates"
echo "    - to window.oTemplates"
echo ""
echo "3.  Compress PNG Images"
echo "    - from Content/src/images/compression"
echo "    - to Content/images"
echo ""
echo "4.  Glue Sprites"
echo "    - from Content/src/images/sprites"
echo "    - image to Content/images/sprites"
echo "    - SCSS to Content/scss/sprites"
echo ""
echo "5.  Compile SCSS"
echo "    - from Content/scss"
echo "    - to Content/css"
echo ""
echo "6.  Watch SCSS"
